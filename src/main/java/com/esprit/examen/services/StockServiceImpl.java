...
public class StockServiceImpl implements IStockService {
	...
	public String retrieveStatusStock() {
		...
		{
			bld.append("\n").append(finalMessage).append(msgDate).append("\n").append(": le stock ").append(stocksEnRouge.get(i).getLibelleStock())
					.append(" a une quantité de ").append(stocksEnRouge.get(i).getQte())
					.append(" inférieur à la quantité minimale a ne pas dépasser de ").
					append(stocksEnRouge.get(i).getQteMin()).append("\n");
		}
